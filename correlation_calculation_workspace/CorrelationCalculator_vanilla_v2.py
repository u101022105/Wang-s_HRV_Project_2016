...
np.savetxt('_vanila_out_'+ file[:-4] + str(cap)+'_by_' + str(version)+'.csv', Tlst, delimiter = ',')
np.savetxt('_vanila_out_'+'fft_'+file[:-4]+ str(cap)+'_by_' + str(version)+'.csv', PD, delimiter = ',')
